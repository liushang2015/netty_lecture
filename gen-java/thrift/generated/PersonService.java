...
public class PersonService {
  ...
  public interface Iface {
    ...
    public Person getPersonByUsername(java.lang.String username) throws DataExceotion, org.apache.thrift.TException;

    public void savePerson(Person person) throws DataExceotion, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person recv_getPersonByUsername() throws DataExceotion, org.apache.thrift.TException
    {
      ...
      if (result.dataExceotion != null) {
        throw result.dataExceotion;
      }
    ...
    public void recv_savePerson() throws DataExceotion, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getPersonByUsername_call extends org.apache.thrift.async.TAsyncMethodCall<Person> {
      ...
      public Person getResult() throws DataExceotion, org.apache.thrift.TException {
    ...
    public static class savePerson_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public Void getResult() throws DataExceotion, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getPersonByUsername<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPersonByUsername_args> {
      ...
      public getPersonByUsername_result getResult(I iface, getPersonByUsername_args args) throws org.apache.thrift.TException {
        ...
        } catch (DataExceotion dataExceotion) {
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Person> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Person>() { 
          ...
          public void onError(java.lang.Exception e) {
            ...
            getPersonByUsername_result result = new getPersonByUsername_result();
            if (e instanceof DataExceotion) {
              result.dataExceotion = (DataExceotion) e;
              result.setDataExceotionIsSet(true);
              msg = result;
  ...
  public static class getPersonByUsername_result implements org.apache.thrift.TBase<getPersonByUsername_result, getPersonByUsername_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUsername_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_EXCEOTION_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExceotion", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable DataExceotion dataExceotion; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      SUCCESS((short)0, "success"),
      DATA_EXCEOTION((short)1, "dataExceotion");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 0: // SUCCESS
            return SUCCESS;
          case 1: // DATA_EXCEOTION
            return DATA_EXCEOTION;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.DATA_EXCEOTION, new org.apache.thrift.meta_data.FieldMetaData("dataExceotion", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DataExceotion.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getPersonByUsername_result(
      Person success,
      DataExceotion dataExceotion)
    {
      this();
      this.success = success;
      this.dataExceotion = dataExceotion;
    }
    ...
    public getPersonByUsername_result(getPersonByUsername_result other) {
      ...
      if (other.isSetDataExceotion()) {
        this.dataExceotion = new DataExceotion(other.dataExceotion);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public DataExceotion getDataExceotion() {
      return this.dataExceotion;
    }

    public getPersonByUsername_result setDataExceotion(@org.apache.thrift.annotation.Nullable DataExceotion dataExceotion) {
      this.dataExceotion = dataExceotion;
      return this;
    }

    public void unsetDataExceotion() {
      this.dataExceotion = null;
    }

    /** Returns true if field dataExceotion is set (has been assigned a value) and false otherwise */
    public boolean isSetDataExceotion() {
      return this.dataExceotion != null;
    }

    public void setDataExceotionIsSet(boolean value) {
      if (!value) {
        this.dataExceotion = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case DATA_EXCEOTION:
        if (value == null) {
          ...
          setDataExceotion((DataExceotion)value);
        }
        break;
    ...
    public boolean equals(getPersonByUsername_result that) {
      ...
      boolean this_present_dataExceotion = true && this.isSetDataExceotion();
      boolean that_present_dataExceotion = true && that.isSetDataExceotion();
      if (this_present_dataExceotion || that_present_dataExceotion) {
        if (!(this_present_dataExceotion && that_present_dataExceotion))
          return false;
        if (!this.dataExceotion.equals(that.dataExceotion))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataExceotion()) ? 131071 : 524287);
      if (isSetDataExceotion())
        hashCode = hashCode * 8191 + dataExceotion.hashCode();
    ...
    public int compareTo(getPersonByUsername_result other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetDataExceotion()).compareTo(other.isSetDataExceotion());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExceotion()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExceotion, other.dataExceotion);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("dataExceotion:");
      if (this.dataExceotion == null) {
        sb.append("null");
      } else {
        sb.append(this.dataExceotion);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class getPersonByUsername_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPersonByUsername_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // DATA_EXCEOTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExceotion = new DataExceotion();
                struct.dataExceotion.read(iprot);
                struct.setDataExceotionIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.dataExceotion != null) {
          oprot.writeFieldBegin(DATA_EXCEOTION_FIELD_DESC);
          struct.dataExceotion.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    public savePerson_result setDataExceotion(@org.apache.thrift.annotation.Nullable DataExceotion dataExceotion) {
      this.dataExceotion = dataExceotion;
      return this;
    }
