...
class DataExceotion(TException):
    """
    Attributes:
     - message
     - callStack
    ...
    def __init__(self, message=None, callStack=None, datel=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.datel = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('DataExceotion')
        ...
        if self.callStack is not None:
            ...
            oprot.writeFieldEnd()
        if self.datel is not None:
            oprot.writeFieldBegin('datel', TType.STRING, 3)
            oprot.writeString(self.datel.encode('utf-8') if sys.version_info[0] == 2 else self.datel)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
all_structs.append(DataExceotion)
DataExceotion.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'message', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'callStack', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'datel', 'UTF8', None, ),  # 3
)
